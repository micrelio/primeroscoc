			...
			<div class="centro2" style="background-color:#e3cfb5;">
				...
				<div>
					<form action="guerras.php" method="get" class="botones">
						<div class="boton"><button class="bot" name="primeros" value="primeros" type="submit">
								<h1>Primeros</h1>
							</button></div>
						<div class="boton"><button name="pekeprimeros" value="pekeprimeros" type="submit">
								<h1>Pekeprimeros</h1>
							</button></div>
					</form>
				</div>
				...
				if (isset($datog2["opponent"]["members"])) {
					$mienbrospk2 = $datog2["opponent"]["members"];
				}
				?>
				<div id="guerrae">
					<div class="wari">
						...
						<table>
							<tr class="logo">
								<td style="width:40%; "> <?php if (isset($datog2["clan"]["name"])) {
																echo $datog2["clan"]["name"];
															} ?></br><img src="<?php if (isset($datog2["clan"]["badgeUrls"]["small"])) {
																					echo $datog2["clan"]["badgeUrls"]["small"];
																				} ?>" />
								</td>
								<td style="font-size:80px;">VS
								</td>
								<td style="width:40%; "> <?php if (isset($datog2["opponent"]["name"])) {
																echo $datog2["opponent"]["name"];
															} ?></br><img src="<?php if (isset($datog2["opponent"]["badgeUrls"]["small"])) {
																					echo $datog2["opponent"]["badgeUrls"]["small"];
																				} ?>" />
								</td>
							</tr>
						</table>
							...
							switch ($estadog2) {
								case "preparation":
									...
									if (isset($datog2["startTime"])) {
										...
										$hie = substr($fechai, 9, 2); //no se porque va mal ajuste de hora + 1; //sacamos 2 numero para horas
										$hiu = substr($fechai, 9, 2); //no se porque va mal ajuste de hora - 5; //sacamos 2 numero para horas
										$him = substr($fechai, 9, 2); //no se porque va mal ajuste de hora- 6; //sacamos 2 numero para horas
									...
									echo "</td>
											...
											<tr>
												<td>Participantes ";
									if (isset($datog2["teamSize"])) {
										echo $datog2["teamSize"];
									}
									"</td>
											</tr>";
									break;
					...
					<div id="guerra">
						<div class="warp">
							...
							<table>
								...
								?>
									<tr>
										<td colspan="3"><?php if (isset($datog2["clan"]["name"])) {
															echo $datog2["clan"]["name"];
														} ?> </td>
									</tr>
									<tr>
										<td colspan="3"><img src="<?php if (isset($datog2["clan"]["badgeUrls"]["medium"])) {
																		echo $datog2["clan"]["badgeUrls"]["medium"];
																	} ?>" /><br><br></td>
									</tr>
									<tr class="marcador">
										<td style="float :left;">estrellas </td>
										<td><?php if (isset($datog2["clan"]["stars"])) {
												echo $datog2["clan"]["stars"];
											} ?></td>
									</tr>
									<tr class="marcador">
										<td style="float :left;">Ataques</td>
										<td><?php if (isset($datog2["clan"]["attacks"])) {
												echo $datog2["clan"]["attacks"];
											} ?></td>
									</tr>
									<tr class="marcador">
										<td style="float :left; ">Destruccion</td>
										<td><?php if (isset($datog2["clan"]["destructionPercentage"])) {
												echo $datog2["clan"]["destructionPercentage"] . "%";
											} ?></td>
									</tr>
								<?php } ?>
							</table>
						...
						<div class="warp">
							<table>
								...
								?>
									<tr>
										<td colspan="3"><?php if (isset($datog2["opponent"]["name"])) {
															echo $datog2["opponent"]["name"];
														} ?> </td>
									</tr>
									<tr>
										<td colspan="3"><img src="<?php if (isset($datog2["opponent"]["badgeUrls"]["medium"])) {
																		echo $datog2["opponent"]["badgeUrls"]["medium"];
																	} ?>" /><br><br></td>
									</tr>
									<tr class="marcador">
										<td style="float :left;">estrellas </td>
										<td><?php if (isset($datog2["opponent"]["stars"])) {
												echo $datog2["opponent"]["stars"];
											} ?></td>
									</tr>
									<tr class="marcador">
										<td style="float :left;">Ataques</td>
										<td><?php if (isset($datog2["opponent"]["attacks"])) {
												echo $datog2["opponent"]["attacks"];
											} ?></td>
									</tr>
									<tr class="marcador">
										<td style="float :left; ">Destruccion</td>
										<td><?php if (isset($datog2["opponent"]["destructionPercentage"])) {
												echo $datog2["opponent"]["destructionPercentage"] . "%";
											} ?></td>
									</tr>
								<?php } ?>
							</table>
							<table cellpadding="0">
								...
								?>
									<tr colspan="2">
										<td style="height:170px;  " colspan="2"><?php $star0 = "starwar0";
																				$star1 = "starwar1";
																				$star2 = "starwar2";
																				$star3 = "starwar3";
