				...
				<div id="actualidad">
					<div>
						<form action="familia.php" method="get" class="botones">
							...
							<div class="boton"><button name="familia" value="familia" type="submit">
									<h1>Familia</h1>
								</button></div>
						</form>
					</div>
					...
					if (isset($_GET["primeros"])) {
						...
						<div id="clanes">
							<table class="clantable">
								<tr>
									...
									<td rowspan="11">descrip<?php if (isset($dato["description"])) {
																echo $dato["description"];
															} ?></td>
								</tr>
								<tr>
									<td>Puntos totales</td>
									<td><?php if (isset($dato["clanPoints"])) {
						...
						<!--clanes-->
					<?php	} else if (isset($_GET["pekeprimeros"])) {
						$dato = $dato2; ?>
						<div id="clanes">
							<table class="clantable">
								<tr>
						...
						<!--clanes-->
					<?php		} else if (isset($_GET["familia"])) {
