...
<script type="text/javascript" src="http://www.24webclock.com/clock24.js"></script><!--comunicacion con reloj-->
<script>
$(function() {
    var pull = $('#pull');
    menu = $('nav ul');
...
<div id="contenedor">
	...
	<div class="contenido">
			...
			<div class="centro">
                ...
                <div class="cont">
					...
					<p>Tras estos largos años se les fueron uniendo grandes luchadores como el inteligente Vid, el marques Dreud, los legendarios Papi y Richard, las amazonas Ninfa y Cristuki o el fuerte Mamba. Por lo que su fuerza y destreza han mejorado. Siguen siendo mancos pero la mano que les falta siempre se la dan todos sus compañeros.</p>
                   	<h>Normas</h>
					<ul>
						<li><p1>Respeto a los compañeros.</p1></li>
						<li><p1>Donaciones equilibradas.</p1></li>
						<li><p1>No pedir antes de donar.</p1></li>
						<li><p1>Los nuevos estan dos guerras sin entrar.</p1></li>
						<li><p1>Siempre con escudo rojo si no tienes reyes disponibles caldero de hechizos y un cuartel oscuro, si tienes todo disponible y quieres guerrear en verde, esta en ti hacer las guerras que quieras seguidas o no entrar en <a href="web/php/guerras.php">Guerras.</a> ( si no es <a href="web/php/guerras.php">Guerra</a> de entrenamiento ).</p1></li>
						<br>
					</ul>
                </div>
				<img src="web/images/imagenes/bottomlaterales.png" alt="" />
		...
		<div id="right">
			<div class="inner">
				<img src="web/images/imagenes/toplaterales.png" alt="" />
				<div style="width:93%; margin:0 auto; overflov:hidden;">
					<script>
  (function() {
...
<gcse:search></gcse:search>
			...
			<div class="inner">
				<img src="web/images/imagenes/toplaterales.png" alt="" />
               		<div class="reloj">
						<h>Horario</h>  <h>España</h>
						<table border="0" bgcolor="#a0a0a0" cellspacing=0 cellpadding=3 class="clock24st" style="line-height:14px; margin: 0 auto; padding:0; -moz-border-radius: 10px; -webkit-border-radius: 10px; ">
							<tr>
			...
			<!--	<div class="twitter">-->
					<a class="twitter-timeline" data-chrome="noheader nofooter noscrollbar transparent" data-width="200"  data-height="400" data-theme="dark" href="https://twitter.com/CocPrimeros">Tweets by CocPrimeros</a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
